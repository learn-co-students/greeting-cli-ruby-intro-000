...
describe './bin/greet executing a CLI Application' do
  it 'outputs a welcome message and asks the user for input' do
    ...
    expect($stdout).to receive(:puts).with("Hello Dave. My name is HAL. What's your name?"), "Make sure bin/greet has code that can output 'Hello Dave. My name is HAL. What's your name?' exactly."
